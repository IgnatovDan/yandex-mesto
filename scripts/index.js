...
- Надо исправить: в названиях JS переменных не должно быть нумерации (например слова 'another'): в проекте будут появляться новые такие элементы и вместо нумераций используйте "самодокументированные" названия
- Надо исправить: в названиях CSS классов не должно быть нумерации (например слова 'another'): в проекте будут появляться новые такие элементы и вместо нумераций используйте "самодокументированные" названия
- Можно лучше: элемент находится внутри popup и вместо 'document' для вызова querySelector можно использовать переменную, которая ссылается на нужный popup. Так не потребуется делать уникальные на всю страницу селекторы для каждого элемента в каждом popup, уменьшится код html и js.
**Самостоятельно проверьте возможность использования для других селекторов**
